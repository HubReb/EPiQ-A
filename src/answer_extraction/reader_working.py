...
class GetBestParagraphs:
    ...
    """
    def __init__(self, level: str = "paragraph", n_top_paragraphs: int = 10,
        ...
        self.bm25, self.paragraphs, self.wiki_index2paragraph_index = \
            self.load_data()
    ...
    def get_best_paragraphs(self,
                            question: Question,
                            article_ids: List[str] = None) -> List[str]:
        """
        ...
        if article_ids is not None:
            ...
            scores = [self.bm25.get_score(question.original_terms, paragraph_id)
